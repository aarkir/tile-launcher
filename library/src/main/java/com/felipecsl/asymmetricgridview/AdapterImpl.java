...
final class AdapterImpl implements View.OnClickListener, View.OnLongClickListener {
  ...
  ViewHolder onCreateViewHolder() {
    ...
    layout.setDividerDrawable(ContextCompat.getDrawable(context, R.drawable.item_divider_horizontal));
  ...
  private LinearLayout findOrInitializeChildLayout(LinearLayout parentLayout, int childIndex) {
    ...
    if (childLayout == null) {
      ...
      childLayout.setDividerDrawable(ContextCompat.getDrawable(context, R.drawable.item_divider_vertical));
